  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.headingRow}>
        <Ionicons name="add-circle" size={28} color="#2c7be5" />
      ...
      {categories.length === 0 ? (
        <View style={styles.errorRow}>
          ...
          <Text style={styles.noCat}> No categories found in mockapi.io</Text>
        </View>
      ) : (
        <View style={styles.optionRow}>
...
const styles = StyleSheet.create({
  ...
  submitBtn: { flexDirection: 'row', backgroundColor: '#2c7be5', borderRadius: 10, padding: 16, alignItems: 'center', justifyContent: 'center', marginTop: 32 },
